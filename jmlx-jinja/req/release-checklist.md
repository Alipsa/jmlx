...
- [ ] The isolated verification repository is created per candidate; do not use `publishToMavenLocal`. The verifier publishes with `:jmlx-jinja:publishMavenPublicationToReleaseVerificationRepository`.
