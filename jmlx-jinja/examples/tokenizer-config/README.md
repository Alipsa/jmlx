...
Compile with Java 21 against a built jmlx-jinja JAR:
    ...
    javac --release 21 --module-path ../../build/libs/jmlx-jinja-0.5.0-SNAPSHOT.jar --add-modules se.alipsa.jmlx.jinja -d . TokenizerConfigExample.java
    java --module-path ../../build/libs/jmlx-jinja-0.5.0-SNAPSHOT.jar --add-modules se.alipsa.jmlx.jinja -cp . example.TokenizerConfigExample
