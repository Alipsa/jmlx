...
/**
 * Layer normalization, delegating to {@link MLXFast#layerNorm(MLXArray, MLXArray, MLXArray,
 * float)}. Both {@code weight} and {@code bias} are required for this layer, same reasoning as
...
public final class LayerNorm extends Module implements UnaryModule {
  ...
  /**
   * Creates a {@code LayerNorm} layer with the given {@code weight}, {@code bias} and
   * numerical-stability {@code eps}.
   */
