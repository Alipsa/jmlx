 ...
 *
 * <p>Delegates to {@code NativeLoader}'s own resolution rather than probing
 * for a directory independently (req/initial-plan.md, Testing approach):
 * divergent logic between the skip gate and the loader produces false skips
 * (library present via system property, tests silently do not run) and false
