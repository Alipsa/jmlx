...
| `mlx_closure_new_func$fun` | upcall interface | implemented | Existing MLXGrad callback implementation | MLXGradTest | — |
...
| `mlx_h.MLX_FLOAT16` | constant | implemented | Existing dtype/device facade support | Existing module tests | — |
| `mlx_h.MLX_FLOAT32` | constant | implemented | Existing dtype/device facade support | Existing module tests | — |
| `mlx_h.MLX_FLOAT64` | constant | unplanned | — | — | — |
| `mlx_h.MLX_GPU` | constant | implemented | Existing dtype/device facade support | Existing module tests | — |
| `mlx_h.MLX_INT16` | constant | unplanned | — | — | — |
| `mlx_h.MLX_INT32` | constant | implemented | Existing dtype/device facade support | Existing module tests | — |
| `mlx_h.MLX_INT64` | constant | unplanned | — | — | — |
| `mlx_h.MLX_INT8` | constant | unplanned | — | — | — |
| `mlx_h.MLX_UINT16` | constant | unplanned | — | — | — |
| `mlx_h.MLX_UINT32` | constant | implemented | Existing dtype/device facade support | Existing module tests | — |
...
| `mlx_h.mlx_add` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_arange` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_argpartition_axis` | downcall | planned | Phase 6.1 selection/random candidate; direct use is probe-only | SelectionAndRandomProbeTest | req/plans/phase6-0b-probe-findings.md |
| `mlx_h.mlx_argsort` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_argsort_axis` | downcall | planned | Phase 6.1 selection/random candidate; direct use is probe-only | SelectionAndRandomProbeTest | req/plans/phase6-0b-probe-findings.md |
...
| `mlx_h.mlx_array_data_float32` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_data_float64` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_array_data_int16` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_array_data_int32` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_array_dtype` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_equal` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_array_eval` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_free` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_array_ndim` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_new_bool` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_new_complex` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_array_new_data` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_array_new_float32` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_new_float64` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_array_new_int` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_set` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_array_shape` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_array_size` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_astype` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_contiguous` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_default_cpu_stream_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_default_gpu_stream_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_degrees` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_depends` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_dequantize` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_device_free` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_device_get_index` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_device_get_type` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_device_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_device_new_type` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_eval` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_full` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_get_active_memory` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_get_cache_memory` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_get_default_device` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_get_default_stream` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_ones` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_partition_axis` | downcall | planned | Phase 6.1 selection/random candidate; direct use is probe-only | SelectionAndRandomProbeTest | req/plans/phase6-0b-probe-findings.md |
...
| `mlx_h.mlx_random_categorical` | downcall | planned | Phase 6.1 selection/random candidate; direct use is probe-only | SelectionAndRandomProbeTest | req/plans/phase6-0b-probe-findings.md |
...
| `mlx_h.mlx_reshape` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_set_default_device` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_set_default_stream` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_set_error_handler` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_slice` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_softmax_axis` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_sort` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_sort_axis` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_split` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_stream_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_string_data` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_string_free` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_string_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_string_new_data` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_string_set` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_subtract` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_sum` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_take_axis` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_topk_axis` | downcall | planned | Phase 6.1 selection/random candidate; direct use is probe-only | SelectionAndRandomProbeTest | req/plans/phase6-0b-probe-findings.md |
...
| `mlx_h.mlx_vector_array_free` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_array_get` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_array_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_array_new_data` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_array_new_value` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_vector_array_set` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_vector_array_set_data` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_array_set_value` | downcall | unplanned | — | — | — |
| `mlx_h.mlx_vector_array_size` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_vector_string_append_value` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_string_free` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_string_get` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
| `mlx_h.mlx_vector_string_new` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
...
| `mlx_h.mlx_vector_string_size` | downcall | implemented | Existing handwritten core/FFI facade support | Existing module tests | — |
